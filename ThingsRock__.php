...
element.style.background = color;
		...
		?>
			...
			<tr>
			<td width="560" height="480" align="left" style="">
		      <table width="573" height="265" border="0" cellpadding="0" cellspacing="0" bgcolor="" style="margin-bottom:10px; border-top:0px solid #CCCCCC; border-bottom:0px solid #CCCCCC">
                <tr>
                  <td width="350" height="265" valign="top"><table width="350" height="234" border="0" cellpadding="0" cellspacing="0" background="img/HomeCoverRect_
			<?php echo(substr($_SESSION['hcolor'],1,6));
			//echo("387A36");
			 ?>.jpg" bgcolor="#FFFFFF" style="background-repeat: no-repeat; border-bottom:1px solid #DDDDDD">
                      <tr>
                        <td height="55" valign="top" background="img/GrayGradbgDown.jpg" style="height:40; line-height:150%; width:340px; font-size:24px; font-weight:bold; background: url(img/GrayGradbgDown.jpg); color:<?php echo($_SESSION['hcolor']); ?>; border-bottom:0px #CCCCCC solid; border-top:0px #CCCCCC solid; padding:5; padding-left:0; padding-top:5; font-family:Georgia, 'Times New Roman', Times, serif">&nbsp;<?php echo($fname) ?>, Happy New Year! </td>
                      </tr>
                      <tr>
                        <td height="127" valign="top" align="left" style="padding-left:10px; padding-bottom:; padding-top:10"><?php if($replied_cnt>0){ ?>
                            <div style=" background:; width:120px; height:15px; margin-bottom:0; font-size:12px; padding:5 0 5 7; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85);"> <a href="recentUpdates.php" class="one"> <strong>Recent (<?php echo($replied_cnt) ?>)</strong></a> </div>
                          <?php }else{ ?>
                            <div style=" background:#F5F5F5; width:120px; height:15px; margin-bottom:0; font-size:12px; padding:5 0 5 7; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85);"> <a href="recentUpdates.php" class="one"> Recent (<?php echo($replied_cnt) ?>)</a> </div>
                          <?php } ?>
                            <?php if($cnt_unread_msg>0){ ?>
                            <div style=" background:; width:120px; height:15px; margin-bottom:0; font-size:12px; padding:5 0 5 7; font-family:Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px;  margin-top:0;"> <a href="MessageList.php" class="one"><strong>Message (<?php echo($cnt_unread_msg."/".$cnt_msg) ?>)</strong></a> </div>
                          <?php }else{ ?>
                            <div style=" background:#F5F5F5; width:120px; height:15px; margin-bottom:0; font-size:12px; padding:5 0 5 7; font-family:Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px;  margin-top:0; opacity:0.9; filter:alpha(opacity=85);"> <a href="MessageList.php" class="one">Message (<?php echo($cnt_unread_msg."/".$cnt_msg) ?>)</a> </div>
                          <?php } ?>
                            <?php if($cnt_friend_rqst>0){ ?>
                            <div style=" background:; width:120px; height:15px; margin-bottom:0; font-size:12px; padding:5 0 5 7; font-family:Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px;  margin-top:0;"> <a href="FriendGroup.php?friendreq=1" class="one"><strong>Request (<?php echo($cnt_friend_rqst."/".$friend_cnt) ?>)</strong></a> </div>
                          <?php }else{ ?>
                            <div style=" background:#F5F5F5; width:120px; height:15px; margin-bottom:0; font-size:12px; padding:5 0 5 7; font-family:Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0;opacity:0.9; filter:alpha(opacity=85);"> <a href="FriendGroup.php?friendreq=1" class="one">Request (<?php echo($cnt_friend_rqst."/".$friend_cnt) ?>)</a> </div>
                          <?php } ?>
                            <div style=" background:#F5F5F5; width:120px; height:15px; margin-bottom:5; font-size:12px; padding:5 0 5 7; font-family:Geneva, Arial, Helvetica, sans-serif; border:0px dashed #CCCCCC; border-top:0px; border-right:0px; border-left:0px; margin-top:0;opacity:0.9; filter:alpha(opacity=85);"> <a href="ManageCourse.php" class="one">My Courses (<?php echo($total_course_subs) ?>)</a></div></td>
                      </tr>
                      <tr>
		...
		while($object = mysql_fetch_object($interview_q)){
			...
			?>
                  ...
                  <td width="223" colspan="2" valign="top" style="padding-top:0; padding-right:0; color: <?php echo($_SESSION['hcolor']); ?>; font-weight:bold; font-size:14px; background:; line-height:150%;" align="right"><table width="215" height="146" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" style="border-left:1px solid #DDDDDD; border-right:1px solid #DDDDDD;">
                    <tr>
                      <td width="206" height="30" align="left" valign="middle" background="img/master.jpg" style="font-size:16px; padding-left:10px; border-bottom:1px solid #999999; background:; font-family: Georgia, 'Times New Roman', Times, serif; color:<?php echo($_SESSION['hcolor']) ?>; font-weight:bold">
					  <img src="img/blackSmileIcon.png" width="14" /> &nbsp;Channels to go!
					  </td>
                    </tr>
                    <tr>
                      <td style="font-size:14px; padding:3 10 5 10" valign="top">
					    <?php if($custom_eventnews=='Y'){?>
						<div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/circle_correct.gif" width="15" />&nbsp;&nbsp; Campus Notices </div>
					    <?php }else{ ?>
						<div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; Campus Notices </div>
					    <?php } ?>
						
						<?php if($custom_freefood=='Y'){?>
						<div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/circle_correct.gif" width="15" />&nbsp;&nbsp; Free Foods </div>
					    <?php }else{ ?>
						<div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; Free Foods </div>
					    <?php } ?>
						
						<?php if($custom_interviewQuestion=='Y'){?>
						<div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/circle_correct.gif" width="15" />&nbsp;&nbsp; Interview Question </div>
					  <?php }else{ ?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; Interview Question </div>
					  <?php } ?>
					  
					  <?php if($custom_jobReferral=='Y'){?>
					<div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/circle_correct.gif" width="15" />&nbsp;&nbsp; Job Referral </div>
					  <?php }else{ ?>
					 <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; Job Referral </div>
					   <?php } ?>
					  
					  <?php if($custom_examQuestion=='Y'){?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="14" />&nbsp;&nbsp; Exam Questions</div>
					  <?php }else{ ?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; Exam Questions</div>
					   <?php } ?>
					  
					  <?php if($custom_ccomment=='Y'){?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/circle_correct.gif" width="15" />&nbsp;&nbsp; Course Comment </div>
					  <?php }else{ ?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; Course Comment </div>
					  <?php } ?>
					  
					  <?php if($custom_house=='Y'){?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/circle_correct.gif" width="15" />&nbsp;&nbsp; House Rentals </div>
					  <?php }else{ ?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; House Rentals </div>
					  <?php } ?>
					  
					  <?php if($custom_article=='Y'){?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/circle_correct.gif" width="15" />&nbsp;&nbsp; Sales & Bargin </div>
					  <?php }else{ ?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; Sales & Bargin </div>
					  <?php } ?>
					  
					  <?php if($custom_features=='Y'){?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/circle_correct.gif" width="15" />&nbsp;&nbsp; Site New Feature</div></td>
                      <?php }else{ ?>
					  <div style=" background:; width:185px; height:15px; margin-bottom:0; font-size:16px; padding:5 5 5 0; font-family: Geneva, Arial, Helvetica, sans-serif; border:1px dashed #999999; border-top:0px; border-right:0px; border-left:0px; margin-top:0; opacity:0.9; filter:alpha(opacity=85); cursor:pointer" onmouseover="this.style.backgroundColor='#EEEEEE';" onmouseout=" this.style.backgroundColor='#F5F5F5';"><img src="img/on-off.png" width="15" />&nbsp;&nbsp; Site New Feature</div></td>
                      <?php } ?>
