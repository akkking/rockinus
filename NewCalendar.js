...
DivContent+="</select>"; 
DivContent+="</td>"; 
DivContent+="<td style=’border-bottom:1px solid #0066FF; background-color:#C7D8FA; font-weight:bold; font-family:Wingdings 2,Wingdings,Webdings; font-size:16px; padding-top:2px; color:#4477FF; cursor:hand’ align=’center’ title=’CLOSE’ onClick=’javascript:HiddenCalendar()’>S</td>"; 
DivContent+="</tr>"; 
