...
**/
		...
		$_SESSION['headicon_rst_msg'] = "<div align='left' style='width:200px; color:$_SESSION[hcolor]; font-size:12px'><strong><img src=img/addsuccessIcon.jpg width=12>&nbsp; Beautiful. New icon is set!</strong></div>"; 
		$_SESSION['rst_flag'] = "success";
		header("location:ThingsRock.php");
 	}else{ 
		$_SESSION['headicon_rst_msg'] = "<div align='left' style='width:200px; color:#B92828; font-size:13px'><strong><img src=img/error_new.jpg width=18>&nbsp; Wrong upload, try again!</strong></div>";
		$_SESSION['rst_flag'] = "error";
 		header("location:ThingsRock.php");
 	} 
 } 
 ?> 