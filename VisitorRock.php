...
<table width="1032" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="647" valign="top" style="background:#FFFFFF; padding:10px 15px 10px 15px;">
	  <?php include("smallMenu.php") ?>

	  <?php 
	include("Visitor.php") 
	?>	</td>
    <td width="385" valign="top" style="padding:10px 0px 0px 10px">
	...
	-->
	  <div id='publishStatusTable' class='publishStatusTable'>
        <table width="360" height="50" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:0px; background: #FFFFFF;">
          <tr>
