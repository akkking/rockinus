...
<table width="320" height="115" border="0" cellpadding="0" cellspacing="0" style="margin-top:5px; margin-bottom:5px;  -moz-border-radius: 5px; border-radius: 5px;">
                <tr>
				  ...
				  <table width="350" height="85" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="350" height="85" valign="top" >
						<?php
			include 'dbconnect.php';
			...
			?>
						<div style="margin-top:0; margin-bottom:15px; padding-left:0; background: #FFFFFF; width:350px;  -moz-border-radius: 5px; border-radius: 5px;">
                          <table width="350" height="36" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="70" align="left" valign="top" style="padding-left:2px;"><?php
...
//				  	$headicon_id = -1;
			...
			if($friend_tag>0) $friend_rmk = "$subject_fname is also your friend";
				...
				?>
                                  <br />
                                  <?php echo("<font color='#999999' style='font-size:12px'>Now $loopname_fname has $no_row_f friend(s) <br>$friend_rmk</font>") ?> <br />
			...
			?>
						<div style="margin-bottom:15px; background:#FFFFFF; width:350px;  -moz-border-radius: 5px; border-radius: 5px;">
                          <table width="350" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="73" height="78" align="left" valign="top"><?php
							  $pic100_Name = $loopname.'60.jpg';
				  $target = "upload/".$loopname;
				  if(is_dir($target))
				  	echo("<a href='UpdateWall.php' class='one'><div style='border:0px solid #EEEEEE'><img src=upload/$loopname/$pic100_Name?".time()." style='border:0px solid #999999' width=55></div></a>");
...
//				  	$headicon_id = -1;
					echo("<a href='EditHeadIcon.php' class='one'><img src=img/NoUserIcon100.jpg style='border:0; border-top:5px solid #FFFFFF' width=55></a>");
                              ...
                              <td width="277" align="left" valign="top" style="padding:0px 10px 5px 5px; font-size:14px; line-height:125%"><?php
                                  ...
                                  <div style="margin-bottom:5px; margin-top:5px; width: 260px;" align="left" class="statusReplyDiv<?php echo($memofid) ?>" id="statusReplyDiv<?php echo($memofid) ?>">
                                    <table width="260" height="45" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" style="border-bottom:0px solid #DDDDDD;">
                                      <tr>
                                        ...
                                        <td width="48" height="20" align="right" valign="top" bgcolor="#F5F5F5" style="padding-top:7px; font-size:12px"><?php if($sender==$uname){ ?>
                                        ...
                                        <td width="100" height="20" align="right" valign="top" bgcolor="#F5F5F5" style="font-size:10px; padding-right:5px; color:#666666; padding-top:5px"><?php echo(getDateName($reply_pdate)) ?> | <?php echo(substr($reply_ptime,0,5)) ?> </td>
                                      </tr>
                                      <tr>
 ...
 $.ajax({
  ...
  $("#commentStatusBtn<?php echo($id) ?>").show();
                                ...
                                <div class="commentStatusDiv<?php echo($id) ?>" id="commentStatusDiv<?php echo($id) ?>" style="margin-top:5;">
                                    ...
                                    <br />
                                    <div class="commentStatusSubmitBtn<?php echo($id) ?>" id="commentStatusSubmitBtn<?php echo($id) ?>" style=" height:15px; padding:2px 5px 2px 5px; background: url(img/master.jpg); display:inline; margin-top:5px; width:60px; border:1px solid #999999; font-size:11px; cursor:pointer; color:#000000; -moz-border-radius: 3px; border-radius: 3px;" align="center">Submit</div>
...
<div style="margin-bottom:20px; margin-top:0px; border:0px #DDDDDD solid; width:350px; background:#FFFFFF;  -moz-border-radius: 5px; border-radius: 5px;">
  <table width="350" height="250" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="472" height="25" valign="top" style="padding:2px 0 5px 0; font-size:14px; font-family:Arial, Helvetica, sans-serif; font-weight:normal"><img src="img/user-silhouette.png" width="11" />&nbsp;
          <?php 
    ...
    <tr>
      <td height="18" align="left" valign="top" style="padding-left:0px; font-size:14px"><?php
    ...
    <tr>
      <td height="35" align="left" valign="top" style=" padding-left:0px; font-size:14px"><script type="text/javascript">
$(function() {
...
?>
    ...
    <tr>
      <td style="padding-left:0px" align="left" valign="top"><?php
...
?>
        ...
        <div style="margin-top:0; padding-left:0; display:; width:320px; background:" class="commentHeadIconDiv<?php echo($loopname) ?>" id="commentHeadIconDiv<?php echo($loopname) ?>" >
            <script type="text/javascript" >
...
xmlhttp.open("GET","PeopleList.php?page="+str+"&limit=30",true);
