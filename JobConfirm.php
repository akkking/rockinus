...
if(isset($_POST['deleteJob'])){
	...
	$q = mysql_query("DELETE FROM rockinus.job_info where job_id=$job_id");
	if(!$q) die(mysql_error());
	$_SESSION['rst_msg']="<div align='center' style='padding-top:10; padding-bottom:10; margin-top:10; color:#336633'><font size=4><strong><img src=img/addsuccessIcon.jpg>&nbsp;&nbsp; This job post has been deleted successfully!</strong><br><br><a href=".$pageName.".php class=one>Go Back</a></font></div>"; 
  ...
  <table width="1024" height="394" border="0" cellpadding="0" cellspacing="0">
    <tr>
	  ...
	  <?php if(isset($_SESSION['rst_msg'])){
		...
		?>	
	  <form method="post" action="JobConfirm.php">
      <input type="hidden" name="job_id" value="<?php echo($job_id) ?>" />
      <input type="hidden" name="pageName" value="<?php echo($pageName) ?>" />
	  <font style="font-size:20px">Are you sure, you want to delete this job post?</font><br /><hr size="2" style="margin-top:15" /><br />
