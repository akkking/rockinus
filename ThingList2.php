...
<table width="630" height="115" border="0" cellpadding="0" cellspacing="0" style="margin-top:5px; margin-right:5px; margin-bottom:5px;">
                <tr>
...
//				  	$headicon_id = -1;
			...
			?>
						<div style="margin-top:0; margin-bottom:0px; padding-left:0; padding-top:10px; padding-bottom: 10px; border-bottom:1px #DDDDDD solid; width:630px">
                          <table width="630" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="75" height="78" align="left" valign="top" style="padding-left:0px; padding-top:5px"><img src="img/tests.png" width="60" /> </td>
                              <td width="513" align="left" valign="top" style="padding-left:15px; padding-top:3; padding-right:5px; font-size:14px; padding-bottom:10px"><?php
                                  ...
                                  <div style="margin-bottom:5px; margin-top:5px; width: 530px;" align="left" class="interviewReplyDiv<?php echo($memofid) ?>" id="interviewReplyDiv<?php echo($q_follow_id) ?>">
                                    <table width="530" height="45" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" style="border-bottom:0px solid #DDDDDD;">
                                      <tr>
                                        ...
                                        <td width="115" height="20" align="center" valign="top" bgcolor="#F5F5F5" style="padding-top:7; font-size:12px"><?php if($sender==$uname){ ?>
                                      ...
                                      <tr>
                                        <td height="20" colspan="3" valign="top" style="line-height:120%; font-size:12px; padding:5"><?php
 ...
 $.ajax({
  ...
  $("#commentInterviewSubmitBtn<?php echo($id) ?>").show();
                                ...
                                <div class="commentInterviewQuestionDiv<?php echo($id) ?>" id="commentInterviewQuestionDiv<?php echo($id) ?>" style="margin-top:5; width:530px">
                                    ...
                                    <br />
                                    <div class="commentInterviewSubmitBtn<?php echo($id) ?>" id="commentInterviewSubmitBtn<?php echo($id) ?>" style=" height:15px; padding:2px 5px 2px 5px; background: url(img/master.jpg); display:inline; margin-top:5px; width:60px; border:1px solid #999999; font-size:11px; cursor:pointer; color:#000000" align="center">Submit</div> <font style="font-size:11px; color:#999999">(Less than 5000 letters)</font> </div></td>
                            </tr>
                          </table>
						  </div>
						<?php 
							...
							?>
						  <div style="margin-top:5; margin-bottom:5px; padding-left:0; padding-top:5; padding-bottom:5; border-bottom:1px #DDDDDD solid; width:630px">
			...
			$("#recipient").val(txt);
				...
				?>
						  ...
						  <div style="margin-top:0; margin-bottom:0; padding-left:0; padding-top:10; padding-bottom:5; border-bottom:1px #DDDDDD solid; width:630px">
                            <table width="630" height="105" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="70" align="left" valign="top" style="padding-top:0px; padding-left:5px"><img src="img/Messages_Green.png" width="60" /></strong></font></td>
                                <td width="560" align="left" valign="top" style="padding-left:20px; font-size:14px; line-height:130%; padding-top:0px"><?php
                            ...
                            <table width="630" height="43" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                ...
                                <td width="440" rowspan="2" valign="top" style="padding-left:5px; padding-top:2px; font-size:13px; color:<?php echo($_SESSION['hcolor']) ?>; font-weight:normal; line-height:150%"><span class="showFriendNewsDiv_<?php echo($id) ?>" id="showFriendNewsDiv_<?php echo($id) ?>" style="cursor:pointer; font-size:14px"><strong><?php echo("$subject") ?></strong></span> <span class="hideFriendNewsDiv_<?php echo($id) ?>" id="hideFriendNewsDiv_<?php echo($id) ?>" style="display:none; cursor:pointer; font-size:14px"><strong><?php echo("$subject") ?></strong></span><br />
                                    ...
                                    <div class="FriendNewsDiv_<?php echo($id) ?>" id="FriendNewsDiv_<?php echo($id) ?>" style="width:350px; line-height:140%; font-size:12px; font-family:Arial, Helvetica, sans-serif; margin-top:10; color:#000000; margin-bottom:5; display:none; padding-left:0px"> <?php echo(addHyperLink(nl2br($action))) ?> </div></td>
...
function loadXMLDocs(str,div_id)
{
	...
	xmlhttp.open("GET","ThingList.php?page="+str+"&limit=35",false);
...
?>
<div id="extendBtnDiv_<?php echo($div_id) ?>" class="extendBtnDiv_<?php echo($div_id) ?>">
<button type="button" onClick="loadXMLDocs('<?php echo($next_page) ?>','<?php echo($div_id) ?>')" style="color:black; font-size:20px; background-color: #DDDDDD; border:0px; height:30; width:630px; cursor: pointer; -moz-border-radius: 5px; border-radius: 5px;">
