...
<table width="577" height="115" border="0" cellpadding="0" cellspacing="0" style="margin-top:5px; margin-right:5px; margin-bottom:5px;">
                <tr>
				  ...
				  <table width="550" height="85" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="550" height="85" valign="top" >
						<?php
			include 'dbconnect.php';
...
$total_items = $a->cnt;
	...
	if((!$limit) || (is_numeric($limit) == false)|| ($limit < 40) || ($limit > 80)) 
		$limit = 1; //default
...
<div style="margin-top:0; margin-bottom:0px; padding-left:0; padding-top:10px; padding-bottom: 10px; border-bottom:1px #DDDDDD solid; width:550px">
                            <table width="550" border="0" cellpadding="0" cellspacing="0">
                              <tr>
								...
								<img src="img/commentIcon.png" width="60" /> </td>
                                <td width="513" align="left" valign="top" style="padding:2px 0 0 15px; font-size:14px">
								<?php
								  ...
								  <div style="margin-bottom:5px; margin-top:5px; width: 450;" align="left" class="statusReplyDiv<?php echo($memofid) ?>" id="statusReplyDiv<?php echo($memofid) ?>">
                                    <table width="450" height="45" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" style="border-bottom:0px solid #DDDDDD;">
                                      <tr>
                                        ...
                                        <td width="139" height="20" align="right" valign="top" bgcolor="#F5F5F5" style="padding-top:7px; font-size:12px">
										<?php if($sender==$uname){ ?>
										...
										<?php } ?>										</td>
                                        <td width="120" height="20" align="right" valign="top" bgcolor="#F5F5F5" style="font-size:10px; padding-right:5px; color:#666666; padding-top:5px">
 ...
 $.ajax({
  ...
  $("#commentStatusBtn<?php echo($id) ?>").show();
                                  ...
                                  <div class="commentStatusDiv<?php echo($id) ?>" id="commentStatusDiv<?php echo($id) ?>" style="margin-top:5;">
                                    ...
                                    <br />
                                <div class="commentStatusSubmitBtn<?php echo($id) ?>" id="commentStatusSubmitBtn<?php echo($id) ?>" style=" height:15px; padding:2px 5px 2px 5px; background: url(img/master.jpg); display:inline; margin-top:5px; width:60px; border:1px solid #999999; font-size:11px; cursor:pointer; color:#000000" align="center">Submit</div>   <font style="font-size:11px; color:#999999">(Less than 500 letters)</font>                                </div></td>
                              </tr>
                            </table>
                          </div>
                          <?php 
...
//						  		echo("SELECT * FROM rockinus.course_info WHERE coid='$id';");
						  ...
						  <div style="margin-top:0; margin-bottom:0; padding-left:0; padding-top:10; padding-bottom:5; border-bottom:1px #DDDDDD solid; width:550px">
						    <table width="550" height="105" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="28" align="left" valign="top" style="padding-top:0px; padding-left:0px">
								<img src="img/Messages_Green.png" width="60" /></strong></font></td>
                                <td align="left" valign="top" style="padding-left:20px; font-size:14px; line-height:130%; padding-top:0px">
								<?php
	  ...
	  $("#showFriendNewsDiv_<?php echo($id) ?>").show();
                          ...
                          <div style="margin-top:0; margin-bottom:0; padding-left:0; padding-top:10; padding-bottom:10; border-bottom:1px #DDDDDD solid; width:550px">
                            <table width="550" height="79" border="0" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="78" rowspan="2" valign="top" style="padding-left:0px; padding-top:2px; font-size:14px; font-weight:normal">
								
							  <img src="img/user_man.png" width="60" /><br /><br />
...
?>
                                    ...
                                    <div id="flashLikeDiv<?php echo($loopname) ?>" class="flashLikeDiv<?php echo($loopname) ?>" style=" display:none; width:100; padding-right:5; margin-top:8"></div> <div id="likeResult<?php echo($loopname) ?>" class="likeResult<?php echo($loopname) ?>" style='display:none; margin-top:15'></div>
				...
				if($icon_gender=='Female')$tmp_gender="her";
                              ...
                              <tr>
                                <td height="35" align="left" valign="top" style="padding:5; padding-top:0; padding-left:10px; font-size:14px">
...
xmlhttp.open("GET","myDefaultAjax3.php?page="+str+"&limit=40",true);
...
?>
<button type="button" onClick="loadXMLDoc('<?php echo($next_page) ?>','<?php echo($div_id) ?>')" style="cursor: hand; color:black; font-size:18px; background-color: #F5F5F5; border:0px; height:30; width:550; cursor:pointer"> 
