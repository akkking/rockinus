...
}else if($cdegree == "Graduate" || $cdegree == NULL ){
              ...
              <table width="880" height="546" border="0" cellpadding="0" cellspacing="0" style="border-left:#CCCCCC dotted 1">
                  ...
                  <tr>
                    ...
                    <td colspan="3">&nbsp;
					  ...
					  <input type="radio" name="cdegree" value="Graduate" <?php echo $cdegree_options[1]; ?>>Graduate
					  <input type="radio" name="cdegree" value="PHD" <?php echo $cdegree_options[2]; ?>>PHD/Doctor
					  <input type="radio" name="cdegree" value="Certificate" <?php echo $cdegree_options[3]; ?>>Certificate Program
					</td>
                  </tr>
                  <tr>
