	...
	<table width="740" height="116" border="0" cellpadding="0" cellspacing="0" style=" margin-top:5; margin-bottom:20">
      <tr>
		...
		<?php 
			...
			<div style="margin-top:10; padding-left:5; padding-top:10; width:240; background: url(img/GrayGradbgDown.jpg); border-top:1px dashed #CCCCCC;">
...
if($no_row_headicon_list == 0 && $headicon_id!=-1){
	$like_uname_list = "<font color='#999999' style='font-size:11px'>(Great to be No.1 to like it, ever)</font>";
...
?>
								<div class="likeBtn" id="likeBtn" style=" height:20; padding:3 8 3 8; background: url(img/master.png); display:inline; margin-bottom:5; border:1px solid #999999; border-top:1px solid #DDDDDD; border-left:1px solid #DDDDDD; font-size:11px; cursor:pointer; color:#000000"><img src="img/headicon_like_F5.jpg" width="10" />&nbsp;&nbsp;Click if you like <?php echo($tmp_gender)?> icon</div>
								<?php }else{ ?>
								<div style='background-image:; background: ; margin-bottom:0; display:inline; border:0px #DDDDDD solid; height:15px; color:#000000; font-weight:bold; font-size:12px'><img src="img/headicon_like_F5.jpg" width="12" />&nbsp;&nbsp;You like this icon :)</div>
								<?php } ?>
			...
			<div style="background:url(img/GrayGradbgDown.jpg); border-top:1px dashed #CCCCCC; margin-top:25;">
  ...
  <tr>
    <td align="left" background="" style="font-size:12px; padding-left:5; padding-top:8; font-weight:bold; background:" valign="top">
	<?php echo("Name:&nbsp;$uid_fname $uid_lname") ?>	</td>
    </tr>
</table>
</div>
			...
			<div style=" height:18; padding:2 5 2 5; background: url(img/master.png); display:inline; border:1px solid #999999; border-top:0px solid #DDDDDD; border-left:1px solid #DDDDDD; font-size:11px; cursor:pointer; color:#000000">Unfriend&nbsp;<?php echo($uid_fname); ?></div>
			</a>
			<?php } ?>
			</td>
        <td width="490" valign="top" style="padding-left:20">
<table cellpadding="0" border="0" cellspacing="0" width="470">
<tr><td width="360">
<div style="margin-bottom:15; padding-left:5; font-size:28px; line-height:150%; font-weight:bold; color:<?php echo($_SESSION['hcolor']) ?>">
<?php 
echo("Hi, I'm $uid_fname<br>Please write on my Paper!") ?>
</div>
</td>
  <td width="90" align="right" valign="top" style="padding-top:10; padding-right:5">
<script type="text/javascript">
$(function() {
...
<?php if($rel_rstatus=="S")echo("<a href='EditUserInfo.php'><div style='font-size:11px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; width:80px; height:20; border:1px #999999 solid; background: url(img/master.jpg); color:#000000;  padding:2 8 2 8; display:inline' align='center'>+ Edit</div></a>&nbsp;&nbsp;<div style=style='font-size:11px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; width:80px; height:20; border:1px #999999 solid; background: url(img/master.jpg); color:#000000;  padding:2 8 2 8; display:inline' align='center'><a href='EditHeadIcon.php'>+ Head Icon</a></div>");
	 else if($rel_rstatus=="P")echo("<div style='font-size:11px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; width:80px; height:20; border:1px #000000 solid; background: url(img/brownBtnBg.jpg); color:#FFFFFF;  padding:2 8 2 8; display:inline' align='center'>Requested</div>");
		 else if($rel_rstatus=="A")echo("<a href='SendMessage.php?recipient=$uid'><div style='font-size:11px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; width:80px; height:20; border:1px #999999 solid; border-left:1px #DDDDDD solid; border-top:1px #DDDDDD solid; background:url(img/master.jpg); color:#000000;  padding:2 8 2 8; display:inline' align='center'><img src='img/littleMessageIcon.jpg' style='border:0px' width='12' />&nbsp; Message</div></a>");
	 else if($rel_rstatus=="X"){
	 	echo("<div style='font-size:13px; font-family:Arial, Helvetica, sans-serif; font-weight:normal; width:80px; height:20; border:1px #000000 solid; background: url(img/brownBtnBg.jpg); color:#FFFFFF;  padding:2 8 2 8; display:inline' align='center'><a href='AcceptFriend.php?sender=$uid'>Accept</a></div>&nbsp;&nbsp;");
	 	echo("<div style='font-size:13px; font-family:Arial, Helvetica, sans-serif; font-weight:normal; width:80px; height:20; border:1px #000000 solid; background: url(img/black_cell_bg.jpg); color:#FFFFFF;  padding:2 8 2 8; display:inline' align='center'><a href='DenyFriend.php?sender=$uid'>Decline</a></div>");
	 }else if($rel_rstatus=="N")echo("<div id='addFriendDiv' class='addFriendDiv' style='font-size:13px; font-family:Arial, Helvetica, sans-serif; font-weight:normal; width:80px; height:20; border:1px #999999 solid; background: url(img/master.jpg); color:#000000;  padding:2 8 2 8; display:inline; cursor:pointer' align='center'>+ Friend</div>");
	 ?>
	 <span id="flashAddFriend" class="flashAddFriend" style=" display:none; width:80; padding-right:5"></span>
 	 <span id="addFriendResult" class="addFriendResult" style='font-size:13px; font-family:Arial, Helvetica, sans-serif; font-weight:normal; width:80px; height:20; border:1px #000000 solid; background: url(img/black_cell_bg.jpg); color:#FFFFFF;  padding:2 8 2 8; display:none; cursor:pointer'></span>
  </td>
</tr></table>
...
while($object = mysql_fetch_object($q_memo)){
	...
	if($descrip==NULL&&$memo_no_row==1){
		echo("<div style='width:450; background: #666666; padding:10; padding-top:5; padding-bottom:6; margin-top:0; margin-bottom:10; line-height:100%; border-top:1px solid #333333; border-bottom:1px solid #333333'><font style='font-size:12px; font-family: Arial, Helvetica, sans-serif; color:#FFFFFF; font-weight:bold'>&nbsp;I haven't written anything yet, just write me anyway :)</font></div>"); 
	}else if($descrip==NULL&&$memo_no_row>1){
		continue;
	}else{ 
		echo("<div style='width:450; background:#F5F5F5; padding:10; margin-top:0; line-height:150%; font-size:13px; border:1px solid #EEEEEE'>".addHyperLink($descrip)."<br><font color=#666666 style='font-size:11px'>(".getDateName($pdate)." | ".substr($ptime,0,5).")</font></div>"); 
	}
...
<table width="450" border="0" cellpadding="0" cellspacing="0" style="margin-bottom:20; border-bottom:0 solid #DDDDDD">
	<tr>
...
$(function() {
	...
	<div class="commentStatusBtn<?php echo($memoid) ?>" id="commentStatusBtn<?php echo($memoid) ?>" style="height:15; padding:2 4 2 4; background: url(img/<?php echo(substr($_SESSION['hcolor'],1,6)."_ajax_button.jpg") ?>); border:1px solid #999999; border-left:1px solid #DDDDDD; border-top:1px solid #DDDDDD; font-size:11px; font-weight:bold; cursor:pointer; color:#000000" align="center">Write <?php echo($uid_fname) ?></div>
	</td>
	</tr>
	<tr>
...
<div id="displayCommentStatus<?php echo($memoid) ?>" class="displayCommentStatus<?php echo($memoid) ?>" style="padding-left:0px; width:450; background:#F5F5F5; padding:10; padding-top:20; margin-top:20; line-height:150%; font-size:13px; border:1px solid #EEEEEE"></div>	
...
<textarea name="contentforown" id="contentforfriend<?php echo($memoid) ?>" style=" width:450; border:1px solid #DDDDDD; height:100px; font-size:13px; font-weight:normal; padding:4px; line-height:140%; font-family: Arial, Helvetica, sans-serif; margin-bottom:10px"></textarea>
			...
			<div class="commentCancelBtn<?php echo($memoid) ?>" id="commentCancelBtn<?php echo($memoid) ?>" style=" height:18; padding:3 8 3 8; background: url(img/master.png); display:inline; margin-top:10; width:70; border:1px solid #CCCCCC; border-top:0px solid #DDDDDD; font-size:11px; font-weight:bold; cursor:pointer" align="center">Next time</div>
                    </form>
</div>
	</td>
	  </tr>
