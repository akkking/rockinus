...
<table width="500" height="50" border="0" cellpadding="0" cellspacing="0" bgcolor="" style=" border-bottom:1px solid #DDDDDD; background:#F5F5F5; margin-bottom:1">
  <tr>
    <td width="390" align="left" style="padding-left:10; font-size:18px; font-weight:bold; color:#333333; font-family:Arial, Helvetica, sans-serif"> ::&nbsp; 
	<?php if($cmajor==NULL || strlen(trim($cmajor))==0)
			echo("Comments on All courses"); 
		else
			echo("Recent Course Comments"); 
		?></td>
    <td width="110" align="right" style="padding-right:10; font-size:13px; font-family: Arial, Helvetica, sans-serif; font-weight:bold;">&nbsp;<?php
...
?>
<table width="500" height="30" style=" font-family:Geneva, Arial, Helvetica, sans-serif; background:#FFFFFF; margin-top:0; border-bottom:1px #DDDDDD dashed;" border="0" cellspacing="0" cellpadding="0">
  <tr>
