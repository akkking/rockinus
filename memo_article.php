...
if(isset($_POST['content']))
{
 ...
 $pdate=$_POST['pdate'];
 $ptime=$_POST['ptime'];
 mysql_query("INSERT INTO rockinus.article_comment(descrip,aid,sender,recipient,pdate,ptime, rstatus) VALUES ('$content','$aid','$sender','$recipient','$pdate', '$ptime','N');");
 $sql_in= mysql_query("SELECT cid FROM rockinus.article_comment ORDER BY cid DESC");
...
<div style="line-height:180%; margin-bottom:10; width: 550; border:0 #EEEEEE solid" id="articleMemo<?php echo($cid) ?>" class="articleMemo<?php echo($cid) ?>">
