...
<div align="center">
  <table width="1024" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" align="center">
    <tr>
	  ...
	  <table width="752" height="85" border="0" cellpadding="0" cellspacing="0" style=" margin-bottom:40">
         <tr>
           <td width="752" valign="top" style="padding-left:10; padding-bottom:5px; background-color:#FFFFFF; padding-top:15">
		   <table border="0" align="center" cellpadding="0" cellspacing="0" style="border:0px #DDDDDD solid; border-top:0">
                <tr>
                  <td width="740" align="center" style="padding-bottom:10px" valign="top"><table width="740" height="40" border="0" cellpadding="0" cellspacing="0" style=" border-top:1px #DDDDDD solid; background:#F5F5F5; margin-bottom:15px">
                      <tr>
                        <td width="570" style="font-size:14px; padding-left:10"><?php
		...
		if(!$q) die(mysql_error());
		$no_row = mysql_num_rows($q);
 		echo("<div style='background-color: ; color: $_SESSION[hcolor]; font-size:14px; padding-left:0px; padding-right:10px; display:inline; border-top:0px #CCCCCC solid; border-left:0px #CCCCCC solid; border-right:0px #CCCCCC solid; padding-top:6px; height:30px; font-weight:bold'>Course Material List <font color=#999999>($no_row)</font></div>");
		?>
				</td>
                        <td width="170" align="right" style="padding-right:10">				
						<a href="userFileList.php"><span style=" height:16; padding:3 8 3 8; background: url(img/master.png); border:1px solid #DDDDDD; border-top:0px solid #DDDDDD; font-size:12px; cursor:pointer; color:#000000; display:inline" align="center">Manage</span></a>&nbsp;<a href="uploadCourseFile.php"><span style=" height:16; padding:3 8 3 8; background: url(img/master.png); border:1px solid #DDDDDD; border-top:0px solid #DDDDDD; font-size:12px; cursor:pointer; color:#000000; display:inline" align="center">+ Upload</span></a>
						</td>
                      </tr>
                     </table>
                     <?php
		...
		?>
                     <table width="740" height="62" border="0" cellpadding="0" cellspacing="0" background="" bgcolor="#FFFFFF" style="margin-top:5px; border-bottom:1px #EEEEEE dashed">
                       <tr>
                         <td width="40" height="26" align="left" valign="top" style="padding-top:5; padding-left:15"><img src="img/fileWhiteIcon.jpg" width="25" /> </td>
                         <td width="200" height="26" align="left" style="padding-left:10px; font-size:13px; font-weight:normal; line-height:120%">
						 <?php 
						 if($dstatus=="R"){
                         ...
                         <td width="70" height="26" align="right" style="font-size:12px; padding-right:10px;"><?php echo($file_size) ?>KB</td>
                         <td width="174" height="26" align="left" style="font-size:12px; padding-left:10px; "><?php echo($dstatus_title) ?></td>
                  <td width="60" height="26" align="right" style="padding-right:10">
						  <span style="font-size:12px; height:15; padding: 3 8 3 8; border:1px #DDDDDD solid; background:#F5F5F5">
						  <a href="FileConfirm.php?file_id=<?php echo($file_id)?>&&pageName=RockerDetail" class=one style="font-size:12px">Delete</a></span>					     </td>
                       </tr>
                       <tr>
                         <td height="35" style="padding-left:5px;">&nbsp;</td>
                         <td height="35" colspan="5" align="left" bgcolor="" style="padding-left:10px; font-size:12px; line-height:150%; color:#999999; font-weight:normal;">
						 <?php echo("$descrip") ?> </td>
                       </tr>
                    </table>
                    <?php } ?>                   </td>
             ...
             <table border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="margin-top:25px; border:0px #DDDDDD solid; border-top:0">
                <tr>
				  ...
				  <table width="740" height="40" border="0" cellpadding="0" cellspacing="0" style="border-top:1px #DDDDDD solid; margin-bottom:15px; background-color:#F5F5F5">
                       <tr>
                         <td width="568" style=" font-size:14px; padding-left:10">
						 <?php
		...
		if($uid==$uname) echo("<div style='background-color: ; color: $_SESSION[hcolor]; font-size:14px; padding-left:0px; padding-right:10px; display:inline; border-top:0px #CCCCCC solid; border-left:0px #CCCCCC solid; border-right:0px #CCCCCC solid; padding-top:6px; height:30px; font-weight:bold'>Resume & Cover Letter List <font color=#999999>($no_row_resume)</font></div>");
		?>                         </td>
                         <td width="172" align="right" style=" padding-right:10">
						<a href="userResumeList.php"><span style=" height:16; padding:3 8 3 8; background: url(img/master.png); border:1px solid #DDDDDD; border-top:0px solid #DDDDDD; font-size:12px; cursor:pointer; color:#000000; display:inline" align="center">Manage</span></a>&nbsp;<a href="uploadCourseFile.php"><span style=" height:16; padding:3 8 3 8; background: url(img/master.png); border:1px solid #DDDDDD; border-top:0px solid #DDDDDD; font-size:12px; cursor:pointer; color:#000000; display:inline" align="center">+ Upload</span></a>
						</td>
                       </tr>
                    </table>
                      <?php
		...
		?>
           <table width="740" height="62" border="0" cellpadding="0" cellspacing="0" background="" bgcolor="#ffffff" style="border-bottom:1px #EEEEEE dashed; margin-top:5px">
                   <tr>
                          <td width="39" height="26" align="left" valign="top" style="padding-top:5; padding-left:15"><img src="img/fileWhiteIcon.jpg" width="25" /> </td>
                          <td width="395" height="26" align="left" style="padding-left:10px; font-size:13px; font-weight:normal">
						  <?php 
						  if($dstatus=="R"){
						 	$file_req = mysql_query("SELECT * FROM rockinus.user_request_file WHERE file_id='$file_id' AND sender='$uname' AND rstatus='A'");
							if(!$file_req) die(mysql_error());
						 ...
						 if($uname==$uid || $dstatus=="A" || ($rel_rstatus=="A" && $dstatus=="F") || $no_file_req>0 )
							...
							?>						</td>
                          <td width="69" height="26" align="right" style="font-size:12px; padding-right:10px;"><?php echo($file_size) ?>KB</td>
                          <td width="177" height="26" align="left" style="font-size:12px; padding-left:10px;"><?php echo($dstatus_title) ?></td>
                          <td width="60" height="26" align="right" style="padding-right:10">
						  <span style="font-size:12px; height:15; padding: 3 8 3 8; border:1px #DDDDDD solid; background:#F5F5F5"><a href="FileConfirm.php?file_id=<?php echo($file_id) ?>&&pageName=RockerDetail" class=one>Delete</a></span>						  </td>
                      </tr>
                        <tr>
                          <td height="35" style="padding-left:5px;">&nbsp;</td>
                          <td height="35" colspan="4" align="left" bgcolor="" style="padding-left:10px; font-size:12px; line-height:150%; color:#999999; font-weight:normal;">
						  <?php echo("$descrip") ?> </td>
                        </tr>
                    </table>
                    <?php } ?>                   </td>
             ...
             <table width="740" height="40" border="0" cellpadding="0" cellspacing="0" style="border-top:1px #DDDDDD solid; margin-top:20px; background-color:#F5F5F5">
                 <tr>
                   <td width="657" style="font-size:14px; padding-left:10">
				   <?php
		include 'dbconnect.php';
...
if($uid==$uname) echo("<strong><div style='background-color: ; color: $_SESSION[hcolor]; font-size:14px; padding-left:0px; padding-right:10px; display:inline; border-top:0px #CCCCCC solid; border-left:0px #CCCCCC solid; border-right:0px #CCCCCC solid; padding-top:6px; height:30px'>Posting History <font color=#999999>($no_row)</font></div></strong>");
?></td>
			...
			if($tbname=="house_info"){
               ...
               <div style="border-bottom:1px #DDDDDD solid; border-top:1px #FFFFFF solid; padding-bottom:15px; padding-top:15px" onmouseover="document.getElementById('dh<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>'; document.getElementById('mh<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>';" onmouseout="document.getElementById('dh<?php echo($id)?>').style.backgroundColor='#FFFFFF';document.getElementById('mh<?php echo($id)?>').style.backgroundColor='#FFFFFF';">
                 <table width="740" height="70" border="0" cellpadding="0" cellspacing="0">
                   ...
                   <tr>
                     <td height="35" align="left" style="padding-left:10px; padding-top:5px; line-height:150%; font-size:13px"><?php 
              ...
              <?php	}else if($tbname=="article_info"){
               ...
               <div style="border-bottom:1px #DDDDDD solid; border-top:0px #EEEEEE solid; padding-bottom:15px; padding-top:15px" onmouseover="document.getElementById('da<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>'; document.getElementById('ma<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>';" onmouseout="document.getElementById('da<?php echo($id)?>').style.backgroundColor='#FFFFFF';document.getElementById('ma<?php echo($id)?>').style.backgroundColor='#FFFFFF';">
                 <table width="740" height="70" border="0" cellpadding="0" cellspacing="0">
                   ...
                   <tr>
                     <td height="35" align="left" valign="top" style="padding: 10; padding-top:5px; font-size:13px; line-height: 150%"><?php 
						  if(strlen($descrip)>20)
						  	echo(substr(nl2br($descrip),0,500)." ...");
						  else
              ...
              <?php 
               ...
               <div style="border-bottom:1px #DDDDDD solid; border-top:1px #FFFFFF solid; padding-bottom:20px; padding-top:15px" onmouseover="document.getElementById('df<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>'; document.getElementById('mf<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>';" onmouseout="document.getElementById('df<?php echo($id)?>').style.backgroundColor='#FFFFFF';document.getElementById('mf<?php echo($id)?>').style.backgroundColor='#FFFFFF';">
                 <table width="740" height="70" border="0" cellpadding="0" cellspacing="0">
                   ...
                   <tr>
                     <td height="35" align="left" style="padding:10px; padding-top:5px; line-height:150%; font-size:13px"><?php 
						  if(strlen($descrip)>20)
						  	echo(substr(nl2br($descrip),0,500)." ...");
						  else
               ...
               <div style="border-bottom:1px #DDDDDD solid; border-top:1px #FFFFFF solid; padding-bottom:20px; padding-top:15px" onmouseover="document.getElementById('df<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>'; document.getElementById('mf<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>';" onmouseout="document.getElementById('df<?php echo($id)?>').style.backgroundColor='#FFFFFF';document.getElementById('mf<?php echo($id)?>').style.backgroundColor='#FFFFFF';">
                 <table width="740" height="70" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                     ...
                     <td width="572" rowspan="2" align="left" valign="top" style="padding:10px; line-height: 150%; font-size:13px">
					 <?php 
						  if(strlen($descrip)>20)
						  	echo(substr(nl2br($descrip),0,500)." ...");
						  else
               ...
               <div style="padding-top:15px; padding-bottom: 15px; border-bottom:1px #DDDDDD solid; border-top:1px #FFFFFF solid">
                 <table width="740" height="131" border="0" cellpadding="0" cellspacing="0">
                   <tr>
                     ...
                     <td width="581" align="left" valign="top" style="padding-left:10px; font-size:14px; font-weight:bold; padding-top:10px; padding-bottom:5">
                       <?php 
								echo(nl2br($descrip));
								?>                     </td>
              ...
              <?php }else if($tbname=="course_memo_info"){ 
               ...
               <div style="border-bottom:1px #DDDDDD solid; border-top:0px #EEEEEE solid;  padding-bottom:20px; padding-top:15px">
                 <table width="740" height="70" border="0" cellpadding="0" cellspacing="0">
                   ...
                   <tr>
                     <td height="35" style="padding-left:10px; line-height:150%; font-size:13px; padding-top: 10" valign="top"><?php 
						echo(nl2br($subject));
							  ?></td>
