...
$q_folllow = mysql_query("SELECT * FROM rockinus.interview_question_follow WHERE $sel_cond ORDER BY q_follow_id DESC");
...
?>
    <table width="740" height="105" border="0" cellpadding="0" cellspacing="0" style="border:1px solid #DDDDDD">
      <tr>
        <td width="253" height="30" align="left" style=" background: url(img/brownBtnBg.jpg); padding-left:15; font-size:12px; font-weight:bold">
		<a href="interviewQuestions.php">Show All Interview Questions</a>
		</td>
        <td width="491" style=" background: url(img/brownBtnBg.jpg); padding-right:15; font-size:12px; font-weight:bold" align="right">
		<a href="postInterviewQuestion.php">+&nbsp; Post Interview Question</a>		</td>
      </tr>
      <tr>
        <td height="73" colspan="2" valign="top" style="border-top:1px solid #333333; padding-bottom:0">
            <div style=" border-bottom:1px dashed #DDDDDD; height:25; padding-top:10; background: url(img/GrayGradbgDown.jpg); font-size:12px; font-family:Arial, Helvetica, sans-serif; margin-top:0; padding-left:15">
			 <?php
		mysql_query("SET NAMES GBK");
...
//			$descrip = substr($descrip,0,120)."...";
			...
			$ptime = $object->ptime;
			?>
<table width="740" height="61" border="0" cellpadding="0" cellspacing="0" style="border-bottom:1px dashed #DDDDDD; margin-bottom:0">
              <tr>
	...
	<?php
		...
		while($object = mysql_fetch_object($q_folllow)){
			...
			$ptime = $object->ptime;
	?>
    <table width="740" border="0" cellspacing="0" cellpadding="0" style="margin-top:15; border:1px solid #DDDDDD">
      <tr>
        <td height="22" style=" font-size:12px; background: url(img/<?php echo(substr($_SESSION['hcolor'],1,6)."_ajax_button.jpg") ?>); padding-left:10px" align="left">
		<?php echo($loopname) ?>
		</td>
      </tr>
      <tr>
        <td align="left" style="padding-top:5 10 10 10; border-top:1px solid #999999; padding-left:10; font-size:12px; font-family:Arial, Helvetica, sans-serif; line-height:130%">
		<?php echo($follow_descrip) ?>
		</td>
      </tr>
    </table>
	<?php } ?>
	...
	<form method="post">
    <table width="740" border="0" cellspacing="0" cellpadding="0" style="margin-top:15; border:0px solid #DDDDDD">
      <tr>
        <td align="left" style="padding-top:5; border-top:0px solid #999999">
		<textarea name="descrip" style="width:740px; height:130px"></textarea>        </td>
      </tr>
      <tr>
        <td align="left" style="padding-top:10; border-top:0px solid #999999">
		<input type="submit" value="Submit" name="newsSubmit" style="height:22; padding:2 7 2 7; background: url(img/black_cell_bg.jpg); cursor:pointer; border:1px solid #333333; font-size:12px; color:#FFFFFF; line-height:120%; display:inline; font-family:Arial, Helvetica, sans-serif" /> 
		&nbsp;&nbsp;&nbsp;<font style="font-size:12px; font-family:Arial, Helvetica, sans-serif; color:#999999">Every solution post gains 25 points, 10000 letters maximum input </font>
		</td>
      </tr>
    </table>
	</form>
