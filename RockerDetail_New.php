...
<div style="background: #F5F5F5; border-bottom:1px #DDDDDD dashed; border-top:1px #DDDDDD dotted; padding-left:15px; padding-top:15px; padding-bottom:15px" align="center">
<table width="1024" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td><table width="990" border="0" cellpadding="0" cellspacing="0" bgcolor="">
      <tr>
        <td width="270" bgcolor="#FFFFFF" style="padding:10px; border:0px #DDDDDD solid"><div id="myBox"></div>
            </td>
        <td width="450" style="padding-left:25px; padding-right:25px; color:#000000" valign="top">
		<table width="399" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="399" height="40" valign="" style="padding-top:5px; border-bottom:0px #999999 solid">
			<font style="font-size:20px; color:#000000; font-weight:bold"><?php echo $uid ?>			</font>			</td>
          </tr>
          <tr>
            <td height="30"><span style="padding-top:3px; padding-bottom:5px; padding-left:0px; font-size:14px; color:#000000">
              <?php 
          ...
          <tr>
            <td height="30" style="color:#000000; font-size:14px">
              <?php
		  ...
		  <tr>
            <td height="30" style="color:#000000; font-size:14px">
              <strong>Personal Website:</strong> &nbsp;http://www.rockinus.com/<?php 
							echo($uid); 
						   ?>            </td>
          </tr>
          <tr>
		...
		<td width="270" valign="top" style="padding:10px" bgcolor="#FFFFFF">
		  <table width="230" height="300" border="0" cellpadding="0" cellspacing="0" bgcolor="#EEEEEE" style="border:0px #DDDDDD solid">
		  <tr>
		  <td height="32" bgcolor="#666666" style=" border-bottom:0px solid #CCCCCC; border-top:0px solid #CCCCCC; padding-left:0px; font-size:14px; font-weight:bold; color:#FFFFFF" align="center">
		  <table width="250" height="30" border="0" cellpadding="0" cellspacing="0">
		    <tr><td bgcolor="#666666" style="font-size:14px; font-weight:bold; padding-left:15px; color:#FFFFFF">
		  <? echo $uid; ?>'s personal status:
		  </td></tr></table>
		  </td></tr>
		  <tr>
		    <td valign="top" bgcolor="#F5F5F5" style="padding:15px; font-size:16px;">
		      <?php
...
<table width="1024" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td align="left" valign="top" style="border-right: 0px solid #CCCCCC; padding-left:0px" width="250px"><table width="1010" border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
        <td width="740" height="271" align="left" valign="top" style="padding-bottom:10px; padding-left:0px; padding-top:2px">
		<table width="405" height="2314" border="0" cellpadding="0" cellspacing="0">
         	<tr>
			<td valign="top" style=""><table style="margin-top:15px; border:1px #EEEEEE solid;" bgcolor="#F5F5F5" align="center">
              <tr>
                <td width="736" align="center" style="padding-bottom:15px"><table width="710" height="35" border="0" cellpadding="0" cellspacing="0" bgcolor="#666666" style="border-top:0px #DDDDDD solid; border-bottom:2px #DDDDDD solid; margin-top:15px; margin-bottom:10px">
                    <tr>
                      <td width="657"><?php
	...
	echo("<strong><div style='background-color: ; color: #FFFFFF; font-size:14px; padding-left:10px; padding-right:10px; display:inline; border-top:0px #CCCCCC solid; border-left:0px #CCCCCC solid; border-right:0px #CCCCCC solid; padding-top:6px; height:30px'>$uid's Course Files Upload List <font color=#666666>($no_row)</font></div></strong>");
				?>
                      ...
                      <td width="83" align="right" style="padding-right:10px; font-size:12px; font-weight:bold; color:<?php echo($_SESSION['hcolor']) ?>"><?php if($uid==$uname)echo("<a href='uploadCourseFile.php'>+ Upload</a>") ?>
                      </td>
                    </tr>
                  </table>
                    <?php
		...
		?>
                    <table width="710" height="30" border="0" cellpadding="0" cellspacing="0" background="" bgcolor="#FFFFFF" style="margin-top:5px">
                      ...
                      <tr>
                        ...
                        <td height="35" colspan="5" align="left" bgcolor="" style="padding-left:10px; font-size:12px; line-height:150%; color:#666666; font-weight:bold; border-bottom:1px #EEEEEE solid"><?php echo("$descrip") ?> </td>
                      </tr>
                    </table>
                  <?php } ?>
                </td>
			  ...
			  <table style="margin-top:15px; border:1px #EEEEEE solid;" bgcolor="#F5F5F5" align="center">
                <tr>
                  <td width="740" align="center" style="padding-bottom:15px"><table width="710" height="35" border="0" cellpadding="0" cellspacing="0" bgcolor="#666666" style="border-top:0px #DDDDDD solid; border-bottom:1px #999999 solid; margin-top:15px; margin-bottom:10px">
                      <tr>
                        <td width="657"><?php
		...
		?>
			  ...
			  <table width="740" height="35" border="0" cellpadding="0" cellspacing="0" style="border-top:0px #DDDDDD solid; border-bottom:4px #999999 solid; margin-top:25px">
              <tr>
                <td width="657">
		<?php
		include 'dbconnect.php';
...
font-size: 10px;background-color: #FFFFFF; border:1 #CCCCCC solid;" name="delmemosubmit2" value="delete" />
	...
	//							echo(substr(date(" G:i:s",time()),2,17));
        ...
        <td width="10" colspan="0" align="left" valign="top" style="border-left: #EEEEEE solid 0; padding-right:0px">&nbsp;</td>
        <td width="260" rowspan="4" valign="top" style="border-left: #DDDDDD solid 0; padding-bottom:15px; padding-top:20px" align="right">
