...
if(isset($_POST['questionSubmit'])){
	...
	if($tag==0){
		...
		$upd = mysql_query("INSERT INTO rockinus.interview_question (creater, company, position, positionCategory, category, descrip,  rstatus, pdate, ptime, qdate) VALUE('$uname','$companyname', '$jobtitle', '$positionCategory', '$category', '$descrip', '$rstatus', CURDATE(), NOW(),'$questionDate');");
		if(!$upd) die(mysql_error());
		//mysql_close($link);
		
		$q_email = mysql_query("SELECT a.email, a.uname FROM rockinus.user_check_info a JOIN rockinus.user_email_setting b ON a.uname=b.uname AND b.interviewQuestion='Y'");
		...
		smtp_mail($email_list, "[Rockinus.Interview.Question] $companyname, $category question", nl2br($descrip), "admin@rockinus.com", $recipient_list, "", ""); 
		
		$_SESSION['rst_msg']="<div align='center' style='width:700; margin-bottom:10; padding-top:10; padding-bottom:10'><strong><font size=3 color=$_SESSION[hcolor]><img src=img/addsuccessIcon_F5.jpg width=15>&nbsp;&nbsp;&nbsp;Question has been posted successfully! <br><br><a href='interviewQuestions.php'><div align='center' style='border:1px solid #DDDDDD; border-right:1px solid #999999; border-bottom:1px solid #999999; background:url(img/".substr($_SESSION['hcolor'],1,6)."_ajax_button.jpg); padding-bottom:3; padding-top:3; width:200; font-size:13px; font-weight:normal; color:#000000'>View All Interview Questions</div></a></font></strong></div>"; 
		...
		$_SESSION['err_rst_msg']="<div align='left' style='width:700; margin-bottom:5; padding-top:5; padding-bottom:5; font-weight:bold; background:; font-size:12px; color:#B92828'>&nbsp;&nbsp;<img src=img/stop.jpg width=10 />&nbsp;&nbsp;&nbsp;$rst_msg</div>"; 
...
<table width="1024" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  <tr>
    <td width="290" valign="top" align="left" style="padding-left:15px">
	<?php 
	include "jobMenu.php";
	?>	</td>
    <td align="center" valign="top" style="padding-top:15;" width="734">
	<?php 
...
?>
	<table width="700" height="337" border="0" cellpadding="0" cellspacing="0" style="border:0px solid #DDDDDD" bgcolor="#FFFFFF">
  <tr>
    <td width="527" height="50" align="left" style="color:#000000; font-size:28px; font-weight:normal; border-bottom:0px solid #DDDDDD; padding-left:15px">
	<img src="img/yellowChatIcon.png" width="25" />&nbsp;&nbsp; Composing Interview Question	</td>
    <td width="187" height="50" align="right" style="padding-right:15; font-size:12px; font-weight:bold; border-bottom:0px solid #DDDDDD;">&nbsp;&nbsp;		  	</td>
  </tr>
  <tr>
    <td height="305" colspan="2" valign="top" style=">
	<form method="post">
	<div style="height:30px">
	  <table width="700" height="30" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="171" height="20" align="right" style="font-size:12px; padding-right:10;">&nbsp;</td>
	...
	<div style="height:27; border-bottom:0px solid #EEEEEE; margin-bottom:5">
      <table width="700" height="25" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="170" style="font-size:12px; padding-right:10;" align="right">Company Name </td>
	...
	<div style="height:27; border-bottom:0px solid #EEEEEE; margin-bottom:5">
      <table width="700" height="25" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="170" style="font-size:12px; padding-right:10;" align="right">Interview Position  </td>
          <td width="587" style="border-bottom:0px solid #EEEEEE; padding-left:10" align="left">
		  <select name="jobtitle" id="jobtitle" style="font-family:Arial, Helvetica, sans-serif; font-size:12px">
							...
							Quality Assurance</option>
   							<option value="Linux Admin" <?php if($jobtitle=="Civil Engineer")echo(" selected") ?>>
							Linux/Unix Admin</option>
	...
	<div style="height:27; border-bottom:0px solid #EEEEEE; margin-bottom:5">
      <table width="700" height="25" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="170" style="font-size:12px; padding-right:10;" align="right">Position Category</td>
	...
	<div style="height:27; border-bottom:0px solid #EEEEEE; margin-bottom:2">
      <table width="700" height="25" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="170" style="font-size:12px; padding-right:10;" align="right">Interview Type  </td>
	  ...
	  <table width="700" height="225" border="0" cellpadding="0" cellspacing="0">
        <tr>
          <td width="170" height="175" align="right" valign="top" style="font-size:12px; padding-right:10; padding-top:10">Interview Question</td>
          <td width="542" style="border-bottom:0px solid #EEEEEE; padding-left:10; padding-top:10" valign="top" align="left">
            <textarea name="descrip" style="width:450; height:200px; font-size:13px; font-family:Arial, Helvetica, sans-serif; padding:4"></textarea><br /><br />
	  ...
	  <table width="700" height="30" border="0" cellpadding="0" cellspacing="0" style="background:#F5F5F5; border-top:1px solid #DDDDDD; border-bottom:0px solid #">
        <tr>
          <td width="171" align="right">	</td>
          <td width="569" align="right" style=" background: #F5F5F5; color: <?php echo($_SESSION['hcolor']) ?>; font-size:12px; font-weight:bold; padding-right:15"></td>
        </tr>
      </table>
	  </form>	  </td>
  </tr>
