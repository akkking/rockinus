...
<div align="center">
  <table width="1024" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" align="center">
    <tr>
      ...
      <td width="760" align="right" valign="top" style="border-right:0px #DDDDDD dashed">
		  <?php include("HeaderEN.php"); ?>
		  <table width="740" height="30" border="0" cellpadding="0" cellspacing="0" style="border-bottom:0; margin-bottom:10">
            <tr>
              <td width="385" style=" font-weight:normal; padding-left:5; font-size:18px" valign="bottom" align="left">
			  Currently <?php if($replied_cnt==0)echo("0"); else echo("<a href='recentUpdates.php'><strong>$replied_cnt</strong></a>") ?> new update(s)
			  </td>
              <td width="355" align="right" style="padding-right:10; font-size:13px">
			   <a href="RockerDetail.php?uid=<?php echo($uname) ?>">
			  <span style=" height:16; padding:3 8 3 8; background: url(img/master.jpg); border:1px solid #666666; border-top:1px solid #DDDDDD; border-left:1px solid #DDDDDD; font-size:12px; cursor:pointer; color:#000000; display:inline" align="center" onmouseover="this.style.background='url(img/GrayGradbgDown.jpg)'" onmouseout="this.style.background='url(img/master.jpg)'">My Paper</span>			  </a>&nbsp; <a href="EditUserInfo.php">
			  <span style=" height:16; padding:3 8 3 8; background: url(img/master.jpg); border:1px solid #666666; border-top:1px solid #DDDDDD; border-left:1px solid #DDDDDD; font-size:12px; cursor:pointer; color:#000000; display:inline" align="center" onmouseover="this.style.background='url(img/GrayGradbgDown.jpg)'" onmouseout="this.style.background='url(img/master.jpg)'">My Profile</span>			  </a>
			  </td>
            </tr>
          </table>
			...
			if($tbname=="house_info"){
                  ...
                  <div style="border-bottom:1px #EEEEEE solid; border-top:1px #FFFFFF solid; padding-bottom:10px; margin-bottom:10px" onmouseover="document.getElementById('dh<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>'; document.getElementById('mh<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>';" onmouseout="document.getElementById('dh<?php echo($id)?>').style.backgroundColor='#FFFFFF';document.getElementById('mh<?php echo($id)?>').style.backgroundColor='#FFFFFF';">
                    <table width="740" height="58" border="0" cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        <td height="23" align="left" style="padding-left:10px; padding-top:5px; padding-bottom:5; line-height:130%; font-size:13px" valign="top"><?php 
                  ...
                  <div style="border-bottom:1px #EEEEEE solid; border-top:1px #FFFFFF solid; padding-bottom:10px; margin-bottom:10px" onmouseover="document.getElementById('df<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>'; document.getElementById('mf<?php echo($id)?>').style.backgroundColor='<?php echo($_SESSION['hcolor']) ?>';" onmouseout="document.getElementById('df<?php echo($id)?>').style.backgroundColor='#FFFFFF';document.getElementById('mf<?php echo($id)?>').style.backgroundColor='#FFFFFF';">
                    <table width="740" height="68" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td width="572" height="35" align="left" style="padding-left:10px; line-height: 150%; font-size:14px; font-weight:bold; color:<?php echo($_SESSION['hcolor']) ?>"><?php 
 ...
 $.ajax({
  ...
  $("#flash<?php echo($id) ?>").hide();
                ...
                <?php }else if($tbname=="course_memo_info"){ 
						  ...
						  ?>
                  <div style="border-bottom:1px #EEEEEE solid; border-top:0px #EEEEEE solid;  padding-bottom:10px; margin-bottom:10px">
